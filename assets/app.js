...
const PROJECTS = [
  ...
  },
  {
    ...
    featured: false,
    image: '/projects/drivegen/App-single.png',
  ...
  },
  {
    ...
    featured: false,
    image: '/projects/fullship/output.png',
  ...
  },
  {
    ...
    domain: 'automation',
    domainLabel: 'AUTOMATION',
    headline: 'Lead distribution & sync orchestrator',
    body: 'Multi-step automation for lead routing, contract generation, and course enrollment. Syncs across GoHighLevel, Stripe, and external APIs.',
    tags: ['Make', 'Webhooks', 'GoHighLevel', 'Stripe API'],
    featured: false,
    image: '/projects/ghl-orchestrator/automation-lead.png',
    link: '/projects/ghl-orchestrator.html',
  },
  {
    id: 'neurolex',
    name: 'NeuroLex',
  ...
  },
  {
    ...
    link: '/projects/instant-translate.html',
  },
  {
    ...
    domain: 'automation',
    domainLabel: 'AUTOMATION',
    headline: 'IT support ticket auto-resolution',
    body: 'Automated system for categorizing and resolving common IT support tickets using AI classification and predefined workflows.',
    tags: ['Python', 'AI', 'REST API', 'Automation'],
    featured: false,
  ...
  },
  {
    ...
    featured: false,
    image: '/assets/img/still-aerospace.jpg',
    link: '/projects/space-mission-sim.html',
  },
  {
    id: 'spese-smart',
    name: 'Spese Smart',
    ...
    link: '/projects/spese-smart.html',
  },
  {
    id: 'vsl-visualizer',
    name: 'VSL Visualizer',
    ...
    domain: 'ai',
    domainLabel: 'AI',
    headline: 'Video Sales Letter script analyzer',
    body: 'AI-powered tool that analyzes and optimizes VSL scripts for conversion rates. Provides real-time feedback and suggestions.',
    tags: ['Python', 'NLP', 'Streamlit'],
    featured: false,
    image: '/projects/vsl-visualizer/App.png',
    link: '/projects/vsl-visualizer.html',
  },
];
